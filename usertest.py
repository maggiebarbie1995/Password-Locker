...
def test_save_multiple_users(self):
    ...
    """
    test_save_multiple_users to check if we can save multiple users to our users list
    """
...
def test_display_user(self):
    ...
    self.assertEqual(len(User.display_user),User.user_list)
...
def test_user_exit(self):
    ...
    user_exist = User.user_exist("Leroy")
...
def test_log_in(self):
    ...
    found_credential = User.log_in("Leroy", "smith","Leroysmith25")
